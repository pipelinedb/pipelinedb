-- regr_sxx
CREATE CONTINUOUS VIEW test_regr_sxx AS SELECT regr_sxx(x::float8, y::float8) FROM stream;
 
-- regr_syy
CREATE CONTINUOUS VIEW test_regr_syy AS SELECT regr_syy(x::integer, y::integer) FROM stream;

-- regr_sxy
CREATE CONTINUOUS VIEW test_regr_sxy AS SELECT regr_sxy(x::float4, y::float4) FROM stream;

-- regr_avgx
CREATE CONTINUOUS VIEW test_regr_avgx AS SELECT regr_avgx(x::numeric, y::numeric) FROM stream;

-- regr_avgy
CREATE CONTINUOUS VIEW test_regr_avgy AS SELECT regr_avgy(x::integer, y::integer) FROM stream;

-- regr_r2
CREATE CONTINUOUS VIEW test_regr_r2 AS SELECT regr_r2(x::integer, y::integer) FROM stream;

-- regr_slope
CREATE CONTINUOUS VIEW test_regr_slope AS SELECT regr_slope(x::float8, y::float8) FROM stream;

-- regr_intercept
CREATE CONTINUOUS VIEW test_regr_intercept AS SELECT regr_intercept(x::integer, y::integer) FROM stream;

-- regr_count
CREATE CONTINUOUS VIEW test_regr_count AS SELECT regr_count(x::integer, y::float4) FROM stream;

-- covar_pop
CREATE CONTINUOUS VIEW test_covar_pop AS SELECT covar_pop(x::float4, y::int4) FROM stream;

-- corr
CREATE CONTINUOUS VIEW test_corr AS SELECT corr(x::float4, y::int4) FROM stream;
...
DROP CONTINUOUS VIEW test_regr_sxx;
DROP CONTINUOUS VIEW test_regr_syy;
DROP CONTINUOUS VIEW test_regr_sxy;
DROP CONTINUOUS VIEW test_regr_avgx;
DROP CONTINUOUS VIEW test_regr_avgy;
DROP CONTINUOUS VIEW test_regr_r2;
DROP CONTINUOUS VIEW test_regr_slope;
DROP CONTINUOUS VIEW test_regr_intercept;
DROP CONTINUOUS VIEW test_regr_count;
DROP CONTINUOUS VIEW test_covar_pop;
DROP CONTINUOUS VIEW test_corr;

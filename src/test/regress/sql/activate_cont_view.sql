...
SELECT name, query FROM pipeline_query WHERE state='a' AND name='cqactivate1';
SELECT name, query FROM pipeline_query WHERE state='a' AND name='cqactivate2';
DEACTIVATE cqactivate1;
DEACTIVATE cqactivate2;
SELECT name, query FROM pipeline_query WHERE state='i' AND name='cqactivate1';
SELECT name, query FROM pipeline_query WHERE state='i' AND name='cqactivate2';
DEACTIVATE cqactivate1;
DEACTIVATE cqactivate2;

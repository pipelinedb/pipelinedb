...
-------------------------------------------------------------------------------
-- Integer averages
CREATE CONTINUOUS VIEW test_int8_avg AS SELECT k::text, AVG(v::int8) FROM int_stream GROUP BY k;
CREATE CONTINUOUS VIEW test_int4_avg AS SELECT k::text, AVG(v::int4) FROM int_stream GROUP BY k;
CREATE CONTINUOUS VIEW test_int2_avg AS SELECT k::text, AVG(v::int2) FROM int_stream GROUP BY k;
...
-------------------------------------------------------------------------------
-- Numeric averages
CREATE CONTINUOUS VIEW test_numeric_avg AS SELECT k::text, AVG(v::numeric) FROM numeric_stream GROUP BY k;

...
DESCR("aggregate transition function");
DATA(insert OID = 3997 ( cq_hypothetical_set_combine_multi	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1016 "1016 1016" _null_ _null_ _null_ _null_ _null_ cq_hypothetical_set_combine_multi _null_ _null_ _null_ ));
DESCR("aggregate combination function");

DATA(insert OID = 3999 ( cq_rank				PGNSP PGUID 12 1 0 2276 0 t f f f f f i 1 0 20 "2276" "{2276}" "{v}" _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("rank of hypothetical row, using hyperloglog");
DATA(insert OID = 5001 ( cq_rank_final			PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 20 "1016 2276" _null_ _null_ _null_ _null_	_null_ cq_hypothetical_rank_final _null_ _null_ _null_ ));
DESCR("aggregate final function");

DATA(insert OID = 5002 ( cq_percent_rank				PGNSP PGUID 12 1 0 2276 0 t f f f f f i 1 0 701 "2276" "{2276}" "{v}" _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("rank of hypothetical row, using hyperloglog");
DATA(insert OID = 5004 ( cq_percent_rank_final			PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ cq_hypothetical_percent_rank_final _null_ _null_ _null_ ));
DESCR("aggregate final function");

DATA(insert OID = 5005 ( cq_cume_dist				PGNSP PGUID 12 1 0 2276 0 t f f f f f i 1 0 701 "2276" "{2276}" "{v}" _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("rank of hypothetical row, using hyperloglog");
DATA(insert OID = 5007 ( cq_cume_dist_final			PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ cq_hypothetical_cume_dist_final _null_ _null_ _null_ ));
DESCR("aggregate final function");

DATA(insert OID = 5008 ( hll_hypothetical_set_transition_multi	PGNSP PGUID 12 1 0 2276 0 f f f f f f i 2 0 2281 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ hll_hypothetical_set_transition_multi _null_ _null_ _null_ ));
DESCR("aggregate transition function");

DATA(insert OID = 5011 ( hll_dense_rank				PGNSP PGUID 12 1 0 2276 0 t f f f f f i 1 0 20 "2276" "{2276}" "{v}" _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("rank of hypothetical row, using hyperloglog");
DATA(insert OID = 5013 ( hll_dense_rank_final			PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 20 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ hll_hypothetical_dense_rank_final _null_ _null_ _null_ ));
DESCR("aggregate final function");

/* streaming count distinct using hyperloglog */
DATA(insert OID = 5014 ( hll_count_distinct				PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 20 "2276" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("distinct count, using hyperloglog");
DATA(insert OID = 5016 ( hll_count_distinct_transition	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 2281 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ hll_count_distinct_transition _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 5019 ( hll_count_distinct_final			PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 20 "2281" _null_ _null_ _null_ _null_ _null_ hll_count_distinct_final _null_ _null_ _null_ ));
DESCR("aggregate final function");
...
DATA(insert OID = 5023 ( cq_percentile_cont		PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1022 "1022 701" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("multiple continuous percentiles using t-digest");
DATA(insert OID = 5024 ( cq_percentile_cont_float8_transition		PGNSP PGUID 12 1 0 2276 0 f f f f f f i 2 0 2281 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ cq_percentile_cont_float8_transition _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 5025 ( cq_percentile_cont_float8_transition_multi	PGNSP PGUID 12 1 0 2276 0 f f f f f f i 2 0 2281 "2281 2276" "{2281,2276}" "{i,v}" _null_ _null_ _null_ cq_percentile_cont_float8_transition_multi _null_ _null_ _null_ ));
DESCR("aggregate transition function");
DATA(insert OID = 5026 ( cq_percentile_cont_float8_combine	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ cq_percentile_cont_float8_combine _null_ _null_ _null_ ));
DESCR("aggregate combination function");
DATA(insert OID = 5027 ( cq_percentile_cont_float8_final	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "2281 701" _null_ _null_ _null_ _null_ _null_ cq_percentile_cont_float8_final _null_ _null_ _null_ ));
DESCR("aggregate final function");

DATA(insert OID = 5028 (hll_print PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 25 "3998" _null_ _null_ _null_ _null_ _null_ hll_print _null_ _null_ _null_ ));
DESCR("hyperloglog print function");

DATA(insert OID = 5032 (bloom_print PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 25 "5030" _null_ _null_ _null_ _null_ _null_ bloom_print _null_ _null_ _null_ ));
DESCR("bloom filter print function");

DATA(insert OID = 5036 (tdigest_print PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 25 "5034" _null_ _null_ _null_ _null_ _null_ tdigest_print _null_ _null_ _null_ ));
DESCR("t-digest print function");

DATA(insert OID = 5040 (cmsketch_print PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 25 "5038" _null_ _null_ _null_ _null_ _null_ cmsketch_print _null_ _null_ _null_ ));
DESCR("count-min sketch print function");

/* PipelineDB combiner stuff, heavily inspired by Postgres-XC coordinator aggregation */
DATA(insert OID = 4301 ( float8_combine	PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ _null_ float8_combine _null_ _null_ _null_ ));
DESCR("aggregate combination function");
DATA(insert OID = 4303 ( numeric_combine	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1231 "1231 1231" _null_ _null_ _null_ _null_ _null_ numeric_combine _null_ _null_ _null_ ));
DESCR("aggregate combination function");
DATA(insert OID = 4304 ( interval_combine	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1187 "1187 1187" _null_ _null_ _null_ _null_ _null_ interval_combine _null_ _null_ _null_ ));
DESCR("aggregate combination function");
DATA(insert OID = 4305 ( int_avg_combine	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1016 "1016 1016" _null_ _null_ _null_ _null_ _null_ int_avg_combine _null_ _null_ _null_ ));
DESCR("AVG(int) combination function");
DATA(insert OID = 4306 ( int8_sum_to_int8	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ int8_sum_to_int8 _null_ _null_ _null_ ));
DESCR("SUM(int) collection function");
DATA(insert OID = 4307 ( float8_regr_combine	PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ _null_ float8_regr_combine _null_ _null_ _null_ ));
...
DATA(insert OID = 4315 (json_object_agg_combine PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ json_object_agg_combine _null_ _null_ _null_ ));
...
DATA(insert OID = 4300 ( combine	PGNSP PGUID 12 1 0 2283 0 t f f f t f i 1 0 2283 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("generic user combine function");

/* hyperloglog aggregate */
DATA(insert OID = 4321 ( hll_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 3998 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("hyperloglog aggregate");

/* hyperloglog aggregate with user-supplied p */
DATA(insert OID = 4322 ( hll_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 3998 "2283 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("hyperloglog aggregate");

/* hyperloglog aggregate transition function */
DATA(insert OID = 4323 ( hll_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 3998 "3998 2283" _null_ _null_ _null_ _null_ _null_ hll_agg_trans _null_ _null_ _null_ ));
DESCR("hyperloglog aggregate");
...
DATA(insert OID = 4326 ( hll_union_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 3998 "3998" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("hyperloglog union aggregate");

/* hyperloglog union aggregate transition function */
DATA(insert OID = 4327 ( hll_union_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 3998 "3998 3998" _null_ _null_ _null_ _null_ _null_ hll_union_agg_trans _null_ _null_ _null_ ));
DESCR("hyperloglog union aggregate");

/* hyperloglog union aggregate transition function */
DATA(insert OID = 4328 ( hll_cardinality	PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 20 "3998" _null_ _null_ _null_ _null_ _null_ hll_cardinality _null_ _null_ _null_ ));
DESCR("hyperloglog cardinality");

/* bloom filter aggregate */
DATA(insert OID = 4329 ( bloom_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5030 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("bloom filter aggregate");

/* bloom filter aggregate with user-supplied p and n */
DATA(insert OID = 4330 ( bloom_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 5030 "2283 701 20" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("bloom filter aggregate");

/* bloom filter aggregate transition function */
DATA(insert OID = 4331 ( bloom_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5030 "5030 2283" _null_ _null_ _null_ _null_ _null_ bloom_agg_trans _null_ _null_ _null_ ));
DESCR("bloom filter aggregate");

/* bloom filter aggregate with p and n transition function */
DATA(insert OID = 4332 ( bloom_agg_transp	PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 5030 "5030 2283 701 20" _null_ _null_ _null_ _null_ _null_ bloom_agg_transp _null_ _null_ _null_ ));
DESCR("bloom filter aggregate");

/* bloom filter union aggregate */
DATA(insert OID = 4333 ( bloom_union_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5030 "5030" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("bloom filter union aggregate");

/* bloom filter union aggregate transition function */
DATA(insert OID = 4334 ( bloom_union_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5030 "5030 5030" _null_ _null_ _null_ _null_ _null_ bloom_union_agg_trans _null_ _null_ _null_ ));
DESCR("bloom filter union aggregate");

/* bloom filter intersection aggregate */
DATA(insert OID = 4335 ( bloom_intersection_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5030 "5030" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("bloom filter intersection aggregate");

/* bloom filter intersection aggregate transition function */
DATA(insert OID = 4336 ( bloom_intersection_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5030 "5030 5030" _null_ _null_ _null_ _null_ _null_ bloom_intersection_agg_trans _null_ _null_ _null_ ));
DESCR("bloom filter intersection aggregate");

/* bloom filter cardinality function */
DATA(insert OID = 4337 ( bloom_cardinality	PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 20 "5030" _null_ _null_ _null_ _null_ _null_ bloom_cardinality _null_ _null_ _null_ ));
DESCR("bloom filter cardinality");

/* bloom filter contains function */
DATA(insert OID = 4338 ( bloom_contains	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 16 "5030 2283" _null_ _null_ _null_ _null_ _null_ bloom_contains _null_ _null_ _null_ ));
DESCR("bloom filter contains item?");
DATA(insert OID = 4385 ( bloom_contains	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 16 "5030 25" _null_ _null_ _null_ _null_ _null_ bloom_contains _null_ _null_ _null_ ));
DESCR("bloom filter contains item?");

/* t-digest aggregate */
DATA(insert OID = 4339 ( tdigest_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5034 "701" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("t-digest aggregate");

/* t-digest aggregate with user-supplied compression */
DATA(insert OID = 4340 ( tdigest_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 5034 "701 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("t-digest aggregate");

/* t-digest aggregate transition function */
DATA(insert OID = 4341 ( tdigest_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5034 "5034 701" _null_ _null_ _null_ _null_ _null_ tdigest_agg_trans _null_ _null_ _null_ ));
DESCR("t-digest aggregate");
...
DATA(insert OID = 4343 ( tdigest_merge_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5034 "5034" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("t-digest merge aggregate");

/* t-digest merge aggregate transition function */
DATA(insert OID = 4344 ( tdigest_merge_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5034 "5034 5034" _null_ _null_ _null_ _null_ _null_ tdigest_merge_agg_trans _null_ _null_ _null_ ));
DESCR("t-digest merge aggregate");

/* t-digest cdf function */
DATA(insert OID = 4345 ( tdigest_cdf	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "5034 701" _null_ _null_ _null_ _null_ _null_ tdigest_cdf _null_ _null_ _null_ ));
DESCR("t-digest cdf");

/* t-digest quantile function */
DATA(insert OID = 4346 ( tdigest_quantile	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "5034 701" _null_ _null_ _null_ _null_ _null_ tdigest_quantile _null_ _null_ _null_ ));
...
DATA(insert OID = 4348 ( cmsketch_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5038 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("count-min sketch aggregate");

/* count-min sketch aggregate with user-supplied eps and p */
DATA(insert OID = 4349 ( cmsketch_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 5038 "2283 701 701" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("count-min sketch aggregate");

/* count-min sketch aggregate transition function */
DATA(insert OID = 4350 ( cmsketch_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5038 "5038 2283" _null_ _null_ _null_ _null_ _null_ cmsketch_agg_trans _null_ _null_ _null_ ));
DESCR("count-min sketch aggregate");

/* count-min sketch aggregate with eps and p transition function */
DATA(insert OID = 4351 ( cmsketch_agg_transp	PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 5038 "5038 2283 701 701" _null_ _null_ _null_ _null_ _null_ cmsketch_agg_transp _null_ _null_ _null_ ));
DESCR("count-min sketch aggregate");

/* count-min sketch merge aggregate */
DATA(insert OID = 4352 ( cmsketch_merge_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5038 "5038" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("count-min sketch merge aggregate");

/* count-min sketch merge aggregate transition function */
DATA(insert OID = 4353 ( cmsketch_merge_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5038 "5038 5038" _null_ _null_ _null_ _null_ _null_ cmsketch_merge_agg_trans _null_ _null_ _null_ ));
DESCR("count-min sketch merge aggregate");

/* count-min sketch count function */
DATA(insert OID = 4354 ( cmsketch_frequency	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 23 "5038 2283" _null_ _null_ _null_ _null_ _null_ cmsketch_frequency _null_ _null_ _null_ ));
...
/* hyperloglog empty */
DATA(insert OID = 4357 ( hll_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 0 0 3998 "" _null_ _null_ _null_ _null_ _null_ hll_empty _null_ _null_ _null_ ));
DESCR("hyperloglog empty");

/* hyperloglog empty with user-supplied p */
DATA(insert OID = 4358 ( hll_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 3998 "23" _null_ _null_ _null_ _null_ _null_ hll_emptyp _null_ _null_ _null_ ));
DESCR("hyperloglog empty");

/* hyperloglog add */
DATA(insert OID = 4359 ( hll_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 3998 "3998 2283" _null_ _null_ _null_ _null_ _null_ hll_add _null_ _null_ _null_ ));
DESCR("hyperloglog add");
DATA(insert OID = 4384 ( hll_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 3998 "3998 25" _null_ _null_ _null_ _null_ _null_ hll_add _null_ _null_ _null_ ));
DESCR("hyperloglog add");

/* bloom filter empty */
DATA(insert OID = 4360 ( bloom_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 0 0 5030 "" _null_ _null_ _null_ _null_ _null_ bloom_empty _null_ _null_ _null_ ));
DESCR("bloom filter empty");

/* bloom filter empty with user-supplied p and n */
DATA(insert OID = 4361 ( bloom_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5030 "701 20" _null_ _null_ _null_ _null_ _null_ bloom_emptyp _null_ _null_ _null_ ));
DESCR("bloom filter empty");

/* bloom filter add */
DATA(insert OID = 4362 ( bloom_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5030 "5030 2283" _null_ _null_ _null_ _null_ _null_ bloom_add _null_ _null_ _null_ ));
DESCR("bloom filter add");
DATA(insert OID = 4382 ( bloom_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5030 "5030 25" _null_ _null_ _null_ _null_ _null_ bloom_add _null_ _null_ _null_ ));
DESCR("bloom filter add");

/* t-digest empty */
DATA(insert OID = 4363 ( tdigest_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 0 0 5034 "" _null_ _null_ _null_ _null_ _null_ tdigest_empty _null_ _null_ _null_ ));
DESCR("t-digest empty");

/* t-digest empty with user-supplied k */
DATA(insert OID = 4364 ( tdigest_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 5034 "23" _null_ _null_ _null_ _null_ _null_ tdigest_emptyp _null_ _null_ _null_ ));
DESCR("t-digest empty");

/* t-digest add */
DATA(insert OID = 4365 ( tdigest_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5034 "5034 701" _null_ _null_ _null_ _null_ _null_ tdigest_add _null_ _null_ _null_ ));
DESCR("t-digest add");

/* count-min sketch empty */
DATA(insert OID = 4366 ( cmsketch_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 0 0 5038 "" _null_ _null_ _null_ _null_ _null_ cmsketch_empty _null_ _null_ _null_ ));
DESCR("count-min sketch empty");

/* count-min sketch empty with user-supplied eps and p */
DATA(insert OID = 4376 ( cmsketch_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5038 "701 701" _null_ _null_ _null_ _null_ _null_ cmsketch_emptyp _null_ _null_ _null_ ));
DESCR("count-min sketch empty");

/* count-min sketch add */
DATA(insert OID = 4377 ( cmsketch_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5038 "5038 2283" _null_ _null_ _null_ _null_ _null_ cmsketch_add _null_ _null_ _null_ ));
DESCR("count-min sketch add");
DATA(insert OID = 4383 ( cmsketch_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5038 "5038 25" _null_ _null_ _null_ _null_ _null_ cmsketch_add _null_ _null_ _null_ ));
DESCR("count-min sketch add");

/* date truncation convenience functions */
DATA(insert OID = 4367 (  year	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ timestamptz_year _null_ _null_ _null_ ));
DESCR("truncate timestamp with time zone to year");

DATA(insert OID = 4368 (  month	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ timestamptz_month _null_ _null_ _null_ ));
DESCR("truncate timestamp with time zone to month");

DATA(insert OID = 4369 (  day	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ timestamptz_day _null_ _null_ _null_ ));
DESCR("truncate timestamp with time zone to day");

DATA(insert OID = 4370 (  hour	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ timestamptz_hour _null_ _null_ _null_ ));
DESCR("truncate timestamp with time zone to hour");

DATA(insert OID = 4371 (  minute	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ timestamptz_minute _null_ _null_ _null_ ));
DESCR("truncate timestamp with time zone to minute");

DATA(insert OID = 4372 (  second	   PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 1184 "1184" _null_ _null_ _null_ _null_ _null_ timestamptz_second _null_ _null_ _null_ ));
DESCR("truncate timestamp with time zone to second");

DATA(insert OID = 4373 (  hash_group	   PGNSP PGUID 12 1 0 2276 0 f f f f f f i 1 0 23 "2276" "{2276}" "{v}" _null_ _null_ _null_ hash_group _null_ _null_ _null_ ));
DESCR("hash one or more values into a 32-bit integer");
#define HASH_GROUP_OID 4373

DATA(insert OID = 4374 (  ls_hash_group	   PGNSP PGUID 12 1 0 2276 0 f f f f f f i 1 0 20 "2276" "{2276}" "{v}" _null_ _null_ _null_ ls_hash_group _null_ _null_ _null_ ));
...
DATA(insert OID = 4379 ( pipeline_streams PGNSP PGUID 12 1 20 0 0 f f f f t t s 0 0 2249 "" "{25,25,1009}" "{o,o,o}" "{schema,name,queries}" _null_ _null_ pipeline_streams _null_ _null_ _null_ ));
DESCR("get streams");

/* t-digest add n */
DATA(insert OID = 4380 ( tdigest_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 5034 "5034 701 23" _null_ _null_ _null_ _null_ _null_ tdigest_addn _null_ _null_ _null_ ));
DESCR("t-digest add");

/* count-min sketch add n */
DATA(insert OID = 4381 ( cmsketch_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 5038 "5038 2283 23" _null_ _null_ _null_ _null_ _null_ cmsketch_addn _null_ _null_ _null_ ));
DESCR("count-min sketch add");
DATA(insert OID = 4387 ( cmsketch_add	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 5038 "5038 25 23" _null_ _null_ _null_ _null_ _null_ cmsketch_addn _null_ _null_ _null_ ));
DESCR("count-min sketch add");

/* generic finalize function */
DATA(insert OID = 4388 ( finalize	PGNSP PGUID 12 1 0 2283 0 t f f f t f i 1 0 2283 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
...
DATA(insert OID = 4391 ( pipeline_version		   PGNSP PGUID 12 1 0 0 0 f f f f t f s 0 0 25 "" _null_ _null_ _null_ _null_ _null_ pipeline_version _null_ _null_ _null_ ));
DESCR("PipelineDB version string");

/* count-min sketch total and normalized frequency */
DATA(insert OID = 4392 ( cmsketch_norm_frequency	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "5038 2283" _null_ _null_ _null_ _null_ _null_ cmsketch_norm_frequency _null_ _null_ _null_ ));
DESCR("count-min sketch estimate norm frequency");
DATA(insert OID = 4393 ( cmsketch_norm_frequency	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 701 "5038 25" _null_ _null_ _null_ _null_ _null_ cmsketch_norm_frequency _null_ _null_ _null_ ));
DESCR("count-min sketch estimate norm frequency");
DATA(insert OID = 4394 ( cmsketch_total	PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 20 "5038" _null_ _null_ _null_ _null_ _null_ cmsketch_total _null_ _null_ _null_ ));
DESCR("count-min sketch total");

/* date_floor */
DATA(insert OID = 4395 (  date_round	   PGNSP PGUID 12 1 0 0 0 f f f f f f s 2 0 1184 "1184 1186" _null_ _null_ _null_ _null_ _null_ timestamptz_round _null_ _null_ _null_ ));
DESCR("round down timestamp with time zone to specified interval");

/* filtered space saving */
DATA(insert OID = 4396 ( fss_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 5041 "2283 20" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("filtered space saving aggregate");
/* filtered space saving aggregate with user-supplied m and h */
DATA(insert OID = 4397 ( fss_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 4 0 5041 "2283 20 20 20" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("filtered space saving aggregate");
/* filtered space saving aggregate transition function */
DATA(insert OID = 4398 ( fss_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 5041 "5041 2283 20" _null_ _null_ _null_ _null_ _null_ fss_agg_trans _null_ _null_ _null_ ));
DESCR("filtered space saving aggregate");
/* filtered space saving aggregate with p and n transition function */
DATA(insert OID = 4399 ( fss_agg_transp	PGNSP PGUID 12 1 0 0 0 f f f f f f i 5 0 5041 "5041 2283 20 20 20" _null_ _null_ _null_ _null_ _null_ fss_agg_transp _null_ _null_ _null_ ));
DESCR("filtered space saving aggregate");
/* filtered space saving union aggregate */
DATA(insert OID = 4400 ( fss_merge_agg	PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 5041 "5041" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("filtered space saving merge aggregate");
/* filtered space saving union aggregate transition function */
DATA(insert OID = 4401 ( fss_merge_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5041 "5041 5041" _null_ _null_ _null_ _null_ _null_ fss_merge_agg_trans _null_ _null_ _null_ ));
DESCR("filtered space saving merge aggregate");
DATA(insert OID = 4403 ( fss_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5041 "2206 20" _null_ _null_ _null_ _null_ _null_ fss_empty _null_ _null_ _null_ ));
DESCR("filtered space saving empty");
/* filtered space saving empty with user-supplied m and h */
DATA(insert OID = 4404 ( fss_empty	PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 5041 "2206 20 20 20" _null_ _null_ _null_ _null_ _null_ fss_emptyp _null_ _null_ _null_ ));
DESCR("filtered space saving empty");
/* filtered space saving add */
DATA(insert OID = 4405 ( fss_increment	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 5041 "5041 2283" _null_ _null_ _null_ _null_ _null_ fss_increment _null_ _null_ _null_ ));
...
DESCR("filtered space saving aggregate");
DATA(insert OID = 4413 ( fss_agg_weighted_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 5041 "5041 2283 20 20" _null_ _null_ _null_ _null_ _null_ fss_agg_weighted_trans _null_ _null_ _null_ ));
DESCR("filtered space saving aggregate with weight");

DATA(insert OID = 4414 (fss_topk_values PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 2277 "5041" _null_ _null_ _null_ _null_ _null_ fss_topk_values _null_ _null_ _null_ ));
DESCR("filtered space saving top-k function");
DATA(insert OID = 4415 (fss_topk_freqs PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 2277 "5041" _null_ _null_ _null_ _null_ _null_ fss_topk_freqs _null_ _null_ _null_ ));
DESCR("filtered space saving top-k function");
/* filtered space saving weighted add */
...
DATA(insert OID = 4420 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 20 "2276 20" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all bigint input values");
DATA(insert OID = 4421 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 23 "2276 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all integer input values");
DATA(insert OID = 4422 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 21 "2276 21" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all smallint input values");
DATA(insert OID = 4423 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 26 "2276 26" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all oid input values");
DATA(insert OID = 4424 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 700 "2276 700" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all float4 input values");
DATA(insert OID = 4425 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 701 "2276 701" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all float8 input values");
DATA(insert OID = 4426 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 702 "2276 702" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all abstime input values");
DATA(insert OID = 4427 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1082 "2276 1082" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all date input values");
DATA(insert OID = 4428 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1083 "2276 1083" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all time input values");
DATA(insert OID = 4429 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1266 "2276 1266" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all time with time zone input values");
DATA(insert OID = 4430 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 790 "2276 790" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all money input values");
DATA(insert OID = 4431 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1114 "2276 1114" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all timestamp input values");
DATA(insert OID = 4432 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1184 "2276 1184" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all timestamp with time zone input values");
DATA(insert OID = 4433 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1186 "2276 1186" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all interval input values");
DATA(insert OID = 4434 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 25 "2276 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all text input values");
DATA(insert OID = 4435 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1700 "2276 1700" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all numeric input values");
DATA(insert OID = 4436 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1042 "2276 1042" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all bpchar input values");
DATA(insert OID = 4437 (  keyed_min				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 27 "2276 27" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all tid input values");
DATA(insert OID = 4438 (  keyed_min			PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 3500 "2276 3500" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed minimum value of all enum input values");

DATA(insert OID = 4439 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 23 "2276 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all integer input values");
DATA(insert OID = 4440 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 21 "2276 21" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all smallint input values");
DATA(insert OID = 4441 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 26 "2276 26" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all oid input values");
DATA(insert OID = 4442 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 700 "2276 700" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all float4 input values");
DATA(insert OID = 4443 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 701 "2276 701" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all float8 input values");
DATA(insert OID = 4444 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 702 "2276 702" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all abstime input values");
DATA(insert OID = 4445 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1082 "2276 1082" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all date input values");
DATA(insert OID = 4446 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1083 "2276 1083" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all time input values");
DATA(insert OID = 4447 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1266 "2276 1266" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all time with time zone input values");
DATA(insert OID = 4448 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 790 "2276 790" _null_ _null_ _null_ _null_	_null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all money input values");
DATA(insert OID = 4449 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1114 "2276 1114" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all timestamp input values");
DATA(insert OID = 4450 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1184 "2276 1184" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all timestamp with time zone input values");
DATA(insert OID = 4451 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1186 "2276 1186" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all interval input values");
DATA(insert OID = 4452 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 25 "2276 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all text input values");
DATA(insert OID = 4453 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1700 "2276 1700" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all numeric input values");
DATA(insert OID = 4454 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 1042 "2276 1042" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all bpchar input values");
DATA(insert OID = 4455 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 27 "2276 27" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all tid input values");
DATA(insert OID = 4456 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 20 "2276 20" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all bigint input values");
DATA(insert OID = 4457 (  keyed_max				PGNSP PGUID 12 1 0 0 0 t f f f f f i 2 0 3500 "2276 3500" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("keyed maximum value of all enum input values");

DATA(insert OID = 4458 ( keyed_min_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 17 "17 2276 2276" _null_ _null_ _null_ _null_ _null_ keyed_min_trans _null_ _null_ _null_ ));
DESCR("keyed min aggregate transition function");
DATA(insert OID = 4459 ( keyed_max_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 17 "17 2276 2276" _null_ _null_ _null_ _null_ _null_ keyed_max_trans _null_ _null_ _null_ ));
DESCR("keyed min aggregate transition function");
DATA(insert OID = 4460 ( keyed_min_max_finalize	PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 2283 "17" _null_ _null_ _null_ _null_ _null_ keyed_min_max_finalize _null_ _null_ _null_ ));
DESCR("keyed min/max aggregate final function");

DATA(insert OID = 4461 ( keyed_min_combine	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ _null_ keyed_min_combine _null_ _null_ _null_ ));
DESCR("keyed min combine function");
DATA(insert OID = 4462 ( keyed_max_combine	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ _null_ keyed_max_combine _null_ _null_ _null_ ));
DESCR("keyed max combine function");

DATA(insert OID = 4463 ( set_agg	PGNSP PGUID 12 1 0 0 0 t f f f t f i 1 0 2277 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("set aggregate function");
DATA(insert OID = 4464 ( set_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 2281 "2281 2283" _null_ _null_ _null_ _null_ _null_ set_agg_trans _null_ _null_ _null_ ));
DESCR("set add function");
DATA(insert OID = 4465 ( set_agg_combine PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 2281 "2281 2281" _null_ _null_ _null_ _null_ _null_ set_agg_combine _null_ _null_ _null_ ));
DESCR("set aggregate combine function");
DATA(insert OID = 4466 ( set_cardinality PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 23 "2281" _null_ _null_ _null_ _null_ _null_ set_cardinality _null_ _null_ _null_ ));
DESCR("set print function");

DATA(insert OID = 4467 ( exact_count_distinct	PGNSP PGUID 12 1 0 0 0 t f f f t f i 1 0 23 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
...
DATA(insert OID = 4508 ( exclusive_set_cardinality_agg	PGNSP PGUID 12 1 0 0 0 t f f f t f i 2 0 17 "2283 25" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ ));
DESCR("exclusive set aggregate function");
DATA(insert OID = 4509 ( exclusive_set_cardinality_agg_trans	PGNSP PGUID 12 1 0 0 0 f f f f f f i 3 0 2281 "2281 2283 25" _null_ _null_ _null_ _null_ _null_ exclusive_set_cardinality_agg_trans _null_ _null_ _null_ ));
...
DATA(insert OID = 4512 ( exclusive_set_cardinality PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 20 "17 25" _null_ _null_ _null_ _null_ _null_ exclusive_set_cardinality _null_ _null_ _null_ ));

...
/* t-digest aggregates */
DATA(insert ( 4339	n 0 tdigest_agg_trans		-	-				-				-				f f 0	5034	0	0		0	_null_ _null_ ));
DATA(insert ( 4340	n 0 tdigest_agg_transp		-	-				-				-				f f 0	5034	0	0		0	_null_ _null_ ));
DATA(insert ( 4343	n 0 tdigest_merge_agg_trans	-	-				-				-				f f 0	5034	0	0		0	_null_ _null_ ));

...
DATA(insert ( 4348	n 0 cms_agg_trans		-	-				-				-				f f 0	5038	0	0		0	_null_ _null_ ));
DATA(insert ( 4349	n 0 cms_agg_transp		-	-				-				-				f f 0	5038	0	0		0	_null_ _null_ ));
DATA(insert ( 4352	n 0 cms_merge_agg_trans	-	-				-				-				f f 0	5038	0	0		0	_null_ _null_ ));

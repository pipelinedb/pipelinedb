...
#endif
PG_KEYWORD("batch_size", BATCH_SIZE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("continuous", CONTINUOUS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("deactivate", DEACTIVATE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("decoded", DECODED, UNRESERVED_KEYWORD)
...
PG_KEYWORD("flush_interval", FLUSH_INTERVAL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("parallelism", PARALLELISM, UNRESERVED_KEYWORD)

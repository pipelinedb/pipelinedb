...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"continuous_queries_enabled", PGC_USERSET, DEVELOPER_OPTIONS,
		 gettext_noop("Continuous queries should be be enabled upon creation."),
		 NULL,
		},
...
static struct config_string ConfigureNamesString[] =
{
...

	{
		{"syslog_ident", PGC_SIGHUP, LOGGING_WHERE,
			gettext_noop("Sets the program name used to identify PipelineDB "
						 "messages in syslog."),
			NULL
		},
		&syslog_ident_str,
...

	{
		{"event_source", PGC_POSTMASTER, LOGGING_WHERE,
			gettext_noop("Sets the application name used to identify "
						 "PipelineDB messages in the event log."),
			NULL
		},
		&event_source,
